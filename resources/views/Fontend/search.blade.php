...
<script>
    ...
    <section class="filter-section">
        <div class="filter">
            ...
            <div>
                <h2 class="filter-color" id="{{strtolower(str_replace(' ', '-',$category->name))}}"  onclick="filterproduct('{{strtolower(str_replace(' ', '-',$category->name))}}')">{{$category->name}}</h2>
            </div>
            @endforeach
